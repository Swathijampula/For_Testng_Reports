...
public class DataDriven {
	...
	ExtentTest test;
	String inputpath="E:\\Selenium\\New_Project\\TestInput\\testinputdata.xlsx";
	String outputpath="E:\\Selenium\\New_Project\\TestOutput\\Register.xlsx";
	File screen;
	@BeforeTest
	public void setUp()
	{
	...
	//row count,here register is sheet name
	...
	FileUtils.copyFile(screen, new File("E://swths//screen//Iteration"+i+"register.png"));
